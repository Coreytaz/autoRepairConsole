...
const rows = [
  ...
  { key: "4", orderNumber: "4",  date: "28.08.21 21:00", request: "Масло ДВС", orderStatus: "Готово", Mark: "Mazda CX-5" },
  ...
  { key: "7", orderNumber: "7",  date: "11.08.21 12:00", request: "Тех. Осмотр", orderStatus: "Готово", Mark: "Mazda CX-5" },
